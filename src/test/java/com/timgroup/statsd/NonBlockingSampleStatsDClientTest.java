...
public class NonBlockingSampleStatsDClientTest {

	private static final int STATSD_SERVER_PORT = 8125;
	private static final String STATSD_SERVER = "localhost"; //"192.168.115.108";

	private final NonBlockingSampleStatsDClient client = new NonBlockingSampleStatsDClient("my.prefix", STATSD_SERVER, STATSD_SERVER_PORT);
