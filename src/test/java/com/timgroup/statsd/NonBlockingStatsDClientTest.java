...
public final class NonBlockingStatsDClientTest {
	...
	public void
		...
		final long maxExpectedValue = afterCompletionTime - startTime;
		final long minExpectedValue = beforeCompletionTime - startTime;
	...
	private static final class DummyStatsDServer {
		...
		public DummyStatsDServer(final int port) {
			try {
