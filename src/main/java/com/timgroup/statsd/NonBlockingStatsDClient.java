 ...
 * 
 * <p>
 * Upon instantiation, this client will establish a socket connection to a StatsD instance running on the specified host and port. Metrics are then sent over
 * this connection as they are received by the client.
 * </p>
 * 
 * <p>
 ...
 * </ul>
 * From the perspective of the application, these methods are non-blocking, with the resulting IO operations being carried out in a separate thread.
 * Furthermore, these methods are guaranteed not to throw an exception which may disrupt application execution.
 * </p>
 * 
 * <p>
...
public final class NonBlockingStatsDClient extends ConvenienceMethodProvidingStatsDClient {
	 ...
	 */
	public NonBlockingStatsDClient(	final String prefix,
	...
	public NonBlockingStatsDClient(	final String prefix,
		...
		try {
			sender = new NonBlockingUdpSender(hostname, port, STATS_D_ENCODING, errorHandler);
		}
	 ...
	 */
	@Override
	public void count(final String aspect,
										final long delta,
	 ...
	 */
	@Override
	public void recordGaugeValue(	final String aspect,
																final long value) {
	...
	@Override
	public void recordGaugeDelta(	final String aspect,
																final long value) {
	...
	private void recordGaugeCommon(	final String aspect,
																	final String value,
	 ...
	 */
	@Override
	public void recordSetEvent(	final String aspect,
	 ...
	 */
	@Override
	public void recordExecutionTime(final String aspect,
																	final long timeInMs,
																	final double sampleRate) {
		send(messageFor(aspect, Long.toString(timeInMs), "ms", sampleRate));
	}

	private String messageFor(final String aspect,
														final String value,
														final String type) {
	...
	private String stringValueOf(final double value) {
